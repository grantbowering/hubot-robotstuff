...
describe 'robotstuff', ->
 beforeEach ->
  ...
  it 'should call people out on their fun', ->
    @room.user.say('alice', 'I\'m fun!').then =>
      expect(@room.messages).to.eql [
        ['alice', 'I\'m fun!']
        ['hubot', 'Yeah I know @alice, I\'ve seen you on the Internet.']
      ]
  ...
  it 'should feel things when other people feel things', ->
    @room.user.say('alice', 'I feel lousy today').then =>
      expect(@room.messages).to.eql [
        ...
        ['hubot', 'I feel metallic. :robot_face:']
      ]

  it 'should feel things when other people ask how it feels', ->
  ...
  it 'should feel things when other people ask how it is', ->
  ...
  it 'should feel things when other people ask how it is doing', ->
  ...
  it 'should respond to who are you', ->
    @room.user.say('alice', 'who are you').then =>
      expect(@room.messages).to.eql [
        ['alice', 'who are you']
        ['hubot', 'http://files.devfacto.com/LinkedFromSlackHubot/robot1.jpg']
      ]
